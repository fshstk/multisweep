...
// encoding and decoding with same direction and order yields the same encoded
// signal normalization is done at the decoding stage
  ...
  switch (N) {
    case 0:
      ...
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(0), 1);
      break;
    case 1:
      SHEval1(fX, fY, fZ, SHcoeffs);
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(1), 4);
      break;
    case 2:
      SHEval2(fX, fY, fZ, SHcoeffs);
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(2), 9);
      break;
    case 3:
      SHEval3(fX, fY, fZ, SHcoeffs);
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(3), 16);
      break;
    case 4:
      SHEval4(fX, fY, fZ, SHcoeffs);
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(4), 25);
      break;
    case 5:
      SHEval5(fX, fY, fZ, SHcoeffs);
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(5), 36);
      break;
    case 6:
      SHEval6(fX, fY, fZ, SHcoeffs);
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(6), 49);
      break;
    case 7:
      SHEval7(fX, fY, fZ, SHcoeffs);
      FloatVectorOperations::multiply(
        SHcoeffs, doEncode ? sqrt4PI : decodeCorrection(7), 64);
      break;
  }
}
