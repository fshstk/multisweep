...
// This class is copied from AudioProcessorValueTreeState.cpp to make it
// accessible.
struct AttachedControlBase
...
public:
  ...
  {
    String text =
      parameter->getText(parameter->getValue(), 2) + " " + parameter->label;
