...
public:
  ...
  {
    if (dynamic_cast<AlertWindow*>(textEditor.getParentComponent()) !=
        nullptr) {
                                 ...
                                 TableHeaderComponent& header) override
  {
    ...
    auto outlineColour =
      header.findColour(TableHeaderComponent::outlineColourId);
                        ...
                        Slider& slider) override
  {
    ...
    if (style == Slider::LinearBar || style == Slider::LinearBarVertical) {
      ...
      const float lineThickness =
        jmin(15.0f, jmin(width, height) * 0.45f) * 0.1f;
                            ...
                            bool isDual)
  {
    ...
    const float pointerLength = (radius - extraMargin - statusOutline -
                                 bedOutline - bedThickness - 1.0f) *
                                0.8f;
                      ...
                      float outlineThickness)
  {
    ...
    Path p;
    p.addEllipse(centreX - halfThickness,
